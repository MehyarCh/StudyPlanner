...
import { ArrowLeft, BookOpen, Calendar, Clock, MapPin, User, Plus, Save } from 'lucide-react'
...
export default function EditCoursePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const fetchCourse = async () => {
    try {
      ...
      setSubmitError('Failed to load course')
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Header */}
      <div className="mb-8">
        <Link href={`/courses/${id}`} className="inline-flex items-center text-gray-300 hover:text-white mb-4">
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-gray-300 mt-2">Update course information</p>
          </div>
        </div>
      </div>
